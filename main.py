...
def person_urn(link: str) -> Dict:
    ...
    try:
        payload = json.dumps({"link": link})
        return make_api_request("POST", "/person_urn", payload)
    except Exception as e:
...
def person_skills(link: str) -> Dict:
    ...
    try:
        payload = json.dumps({"link": link})
        return make_api_request("POST", "/person_skills", payload)
    except Exception as e:
...
def search_people_with_filters(keyword: str, page: int = 1, title_free_text: str = None, 
    ...
    try:
        ...
        return make_api_request("POST", "/search_people_with_filters", json.dumps(payload))
    except Exception as e:
...
def company(link: str) -> Dict:
    ...
    try:
        payload = json.dumps({"link": link})
        return make_api_request("POST", "/company", payload)
    except Exception as e:
...
def company_jobs(company_url: str, starts_from: int = 0, count: int = 10) -> Dict:
    ...
    try:
        ...
        return make_api_request("POST", "/company_jobs", payload)
    except Exception as e:
...
def search_company_with_filters(keyword: str, page: int = 1, company_size_list: str = None, 
    ...
    try:
        ...
        return make_api_request("POST", "/search_company_with_filters", json.dumps(payload))
    except Exception as e:
...
def post(link: str) -> Dict:
    ...
    try:
        payload = json.dumps({"link": link})
        return make_api_request("POST", "/post", payload)
    except Exception as e:
...
def search_posts(query: str, page: int = 1, filters: List[Dict] = None) -> Dict:
    ...
    try:
        ...
        return make_api_request("POST", "/search_posts", json.dumps(payload))
    except Exception as e:
...
def profile_updates(profile_url: str, page: int = 1, paginationToken: str = None) -> Dict:
    ...
    try:
        ...
        return make_api_request("GET", f"/profile_updates?{query_string}")
    except Exception as e:
...
def comments_from_recent_activity(profile_url: str, page: int = 1, paginationToken: str = None) -> Dict:
    ...
    try:
        ...
        return make_api_request("GET", f"/comments_from_recent_activity?{query_string}")
    except Exception as e:
...
def company_updates(company_url: str, page: str = "1", paginationToken: str = None) -> Dict:
    ...
    try:
        ...
        return make_api_request("GET", f"/company_updates?{query_string}")
    except Exception as e:
...
def company_employee_count_per_skill(keyword: str, company_url: str) -> Dict:
    ...
    try:
        ...
        return make_api_request("POST", "/company_employee_count_per_skill", payload)
    except Exception as e:
...
def school_alumini_count_per_skill(keyword: str, schoolUrl: str, skillExplicits: str = None) -> Dict:
    ...
    try:
        ...
        return make_api_request("POST", "/school_alumini_count_per_skill", json.dumps(payload))
    except Exception as e:
...
def company_employee(company_id: str, page: int = 1) -> Dict:
    ...
    try:
        ...
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/company_employee?{query_string}")
    except Exception as e:
...
def post_reactions(reactions_urn: str, pagination_token: str = None) -> Dict:
    ...
    try:
        ...
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/post_reactions?{query_string}")
    except Exception as e:
...
def post_comments(comments_urn: str, pagination_token: str = None) -> Dict:
    ...
    try:
        ...
        if pagination_token:
            params["pagination_token"] = pagination_token
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/post_comments?{query_string}")
    except Exception as e:
...
def post_reposts(reposts_urn: str, pagination_token: str = None) -> Dict:
    ...
    try:
        ...
        if pagination_token:
            params["pagination_token"] = pagination_token
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/post_reposts?{query_string}")
    except Exception as e:
...
def search_posts_with_filters(query: str = None, sort_by: str = None, from_member: str = None, 
    ...
    try:
        ...
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/search_posts_with_filters?{query_string}")
    except Exception as e:
...
def search_jobs(query: str, page: str = "1", searchLocationId: str = None, experience: str = None,
    ...
    try:
        ...
        # Convert params to query string with URL encoding
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/search_jobs?{query_string}")
    except Exception as e:
...
def job_details(job_id: str) -> Dict:
    ...
    try:
        params = {"jobId": job_id}
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/job_details?{query_string}")
    except Exception as e:
...
def similar_profiles(profileUrl: str) -> Dict:
    ...
    try:
        ...
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/similar_profiles?{query_string}")
    except Exception as e:
...
def suggestion_location(query: str) -> Dict:
    ...
    try:
        params = {"query": query}
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/suggestion_location?{query_string}")
    except Exception as e:
...
def suggestion_company(query: str) -> Dict:
    ...
    try:
        params = {"query": query}
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/suggestion_company?{query_string}")
    except Exception as e:
...
def suggestion_school(query: str) -> Dict:
    ...
    try:
        params = {"query": query}
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/suggestion_school?{query_string}")
    except Exception as e:
...
def suggestion_industry(query: str) -> Dict:
    ...
    try:
        params = {"query": query}
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/suggestion_industry?{query_string}")
    except Exception as e:
...
def suggestion_service_catagory(query: str) -> Dict:
    ...
    try:
        params = {"query": query}
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/suggestion_service_catagory?{query_string}")
    except Exception as e:
...
def suggestion_person(query: str) -> Dict:
    ...
    try:
        params = {"query": query}
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/suggestion_person?{query_string}")
    except Exception as e:
...
def search_geourns(keyword: str) -> Dict:
    ...
    try:
        ...
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/search_geourns?{query_string}")
    except Exception as e:
...
def suggestion_function(query: str = None) -> Dict:
    ...
    try:
        ...
        if query:
            params["query"] = query
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/suggestion_function?{query_string}")
    except Exception as e:
...
def suggestion_company_size() -> Dict:
    ...
    """
    try:
        return make_api_request("GET", "/suggestion_company_size")
    except Exception as e:
...
def suggestion_language() -> Dict:
    ...
    """
    try:
        return make_api_request("GET", "/suggestion_language")
    except Exception as e:
...
def profiles_david(links: List[str]) -> Dict:
    ...
    try:
        payload = json.dumps({"links": links})
        return make_api_request("POST", "/profiles_david", payload)
    except Exception as e:
...
def private_chtiouisk(links: List[str], count: int = 5) -> Dict:
    ...
    try:
        payload = json.dumps({"links": links, "count": count})
        return make_api_request("POST", "/private_chtiouisk", payload)
    except Exception as e:
...
def person_data_with_open_to_work_flag(link: str) -> Dict:
    ...
    try:
        payload = json.dumps({"link": link})
        return make_api_request("POST", "/person_data_with_open_to_work_flag", payload)
    except Exception as e:
...
def private_company_insights_2(link: str) -> Dict:
    ...
    try:
        params = {"link": link}
        query_string = "&".join([f"{k}={urllib.parse.quote(str(v))}" for k, v in params.items()])
        return make_api_request("GET", f"/private_company_insights_2?{query_string}")
    except Exception as e:
...
def profile_posts_all(link: str) -> Dict:
    ...
    conn = http.client.HTTPSConnection(LINKEDIN_API_HOST)
    payload = json.dumps({"link": link})
    conn.request("POST", "/profile_posts_all", payload, get_linkedin_headers())
    response = conn.getresponse()
    data = response.read()
    return json.loads(data.decode("utf-8"))
...
def person_data_with_experiences(link: str) -> Dict:
    ...
    conn = http.client.HTTPSConnection(LINKEDIN_API_HOST)
    payload = json.dumps({"link": link})
    conn.request("POST", "/person_data_with_experiences", payload, get_linkedin_headers())
    response = conn.getresponse()
    data = response.read()
    return json.loads(data.decode("utf-8"))
...
def person_data_with_languages(link: str) -> Dict:
    ...
    conn = http.client.HTTPSConnection(LINKEDIN_API_HOST)
    payload = json.dumps({"link": link})
    conn.request("POST", "/person_data_with_languages", payload, get_linkedin_headers())
    response = conn.getresponse()
    data = response.read()
    return json.loads(data.decode("utf-8"))
...
def person_data_with_educations(link: str) -> Dict:
    ...
    conn = http.client.HTTPSConnection(LINKEDIN_API_HOST)
    payload = json.dumps({"link": link})
    conn.request("POST", "/person_data_with_educations", payload, get_linkedin_headers())
    response = conn.getresponse()
    data = response.read()
    return json.loads(data.decode("utf-8"))
